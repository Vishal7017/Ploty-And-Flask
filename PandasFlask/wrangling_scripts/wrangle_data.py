...
def return_figures():
  ...
  # as a line chart
    ...
    graph_one = []
    df = cleandata('data/API_SP.RUR.TOTL.ZS_DS2_en_csv_v2_2446153.csv')
...
# fourth chart shows rural population vs arable land
    ...
    df_one = cleandata('data/API_SP.RUR.TOTL.ZS_DS2_en_csv_v2_2446153.csv', keepcolumns, valuevariables)
    df_two = cleandata('data/API_SP.RUR.TOTL.ZS_DS2_en_csv_v2_2446153.csv', keepcolumns, valuevariables)
